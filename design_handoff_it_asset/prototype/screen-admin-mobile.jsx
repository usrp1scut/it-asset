...
const AdminMobile = ({ onClose }) => {
  ...
  return (
    <div style={{
      ...
      {openApproval && (
        <AdminMobileApprovalSheet approval={openApproval} onClose={() => setOpenApproval(null)} />
      )}
...
const AdminMobileHome = ({ onNav }) => {
  ...
  return (
    <div style={{ paddingBottom: 80 }}>
      ...
      {/* Quick action grid */}
      <div style={{
        margin: '-18px 12px 0', padding: '14px 8px', borderRadius: 14, background: '#fff',
        ...
        <QuickAction icon="user" label="离职归还" color="#7E5EE5" bg="#F1ECFF" badge={overdueOffboarding} onClick={() => {}} />
      </div>
